...
def startDwnld():
    ...
    try:
        ...
        strm = yt.streams.filter(res = "720p").first()
...
if __name__ == "__main__":
    ...
    urlENtry = Entry(root,font = "comicsansms 20", justify = CENTER, relief = RIDGE, borderwidth = 5, bg = 'gray49')
    ...
    vTitle = Label(root, font = "comicsansms 10 bold ", bg = 'grey9', fg = 'green yellow')

     
    # Creating watermark label
    watermarkLabel = Label(root, text = "by Bodhi", font = "comicsansms 12", fg = 'green', bg = 'grey9' )
    watermarkLabel.pack(side = BOTTOM, anchor = SE, padx = 8, pady = 5)
    

    # Creating the download button
    dwnldBtn = Button(root, text = "DOWNLOAD", font = "cooper 22", fg = 'orangered', bg = 'grey9', relief = RIDGE, command = startDwnldThread)
